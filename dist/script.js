function init() {  
  ...
  const addBunny = () => {
    const bunny = {
      ...
      { 
        ...
        innerHTML: '<img src="photo_2024-10-16 19.07.05.jpeg" class="bunny sprite" />'
      }),
      sprite: {
        el: null,
        x: 0, y: 0
  ...
  const hugBunny = bunny => {
    ...
    // Заміна зображення зайця на зображення обіймів
    bunny.el.innerHTML = '<img src="photo_2024-10-16 19.09.43.jpeg" class="bunny sprite" />'; // Заміна на ваше зображення
    bunny.el.classList.add(classToAdd);
    ...
    setTimeout(() => {
        ...
        bunny.el.innerHTML = '<img src="photo_2024-10-16 19.12.53.jpeg" class="bunny sprite" />'; // Заміна на ваше оригінальне зображення
